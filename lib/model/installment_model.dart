...
Installment installmentFromJson(String str) =>
    Installment.fromJson(json.decode(str));
...
class Installment {
  ...
  factory Installment.fromJson(Map<String, dynamic> json) => Installment(
        installment: List<InstallmentElement>.from(
            json["installment"].map((x) => InstallmentElement.fromJson(x))),
      );
...
class InstallmentElement {
  ...
  factory InstallmentElement.fromJson(Map<String, dynamic> json) =>
      InstallmentElement(
        amount: json["amount"],
        paid: json["paid"],
